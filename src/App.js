  ...
  return (
    <div className="pl-[70px]">
     ...
     <div className="w-full p-5">
       ...
       <div id="music" className="mt-14">
       <Slider title="Music" data={data}/>
       </div>

       <div id="books" className="mt-14">
